...
% \titlespacing{\subsection}{0pt}{2.75ex plus 1ex minus .2ex}{1.25ex plus .2ex}
% \titlespacing{\subsubsection}{0pt}{2.75ex plus 1ex minus .2ex}{1.25ex plus .2ex}

% % Reduce chapter heading space
...
% Shorthand macros for overrightarrow and overleftarrow
\newcommand{\ora}{\overrightarrow}
\newcommand{\ola}{\overleftarrow}

% Macros for CMCD forward and backward processes with hardcoded phi
\newcommand{\fwdPcmcd}[1]{\ora{\P}^{#1, \phi}_{\text{CMCD}}}
\newcommand{\bwdPcmcd}[1]{\ola{\P}^{#1, \phi}_{\text{CMCD}}}

\newcommand{\fwdPcmcdstar}[1]{\ora{\P}^{#1, \phi^{\star}}_{\text{CMCD}}}
\newcommand{\bwdPcmcdstar}[1]{\ola{\P}^{#1, \phi^{\star}}_{\text{CMCD}}}

% Define \citep as a macro for \parencite
\newcommand{\citep}{\parencite}

% Macros for vector notation and matrix notation
\newcommand{\vx}{x}
\newcommand{\vy}{y}
\newcommand{\mY}{Y}
\newcommand{\mH}{H}
...
\newcommand{\bwd}{\overleftarrow}
\newcommand{\rv}{\overleftarrow}
\newcommand{\Pm}{\mathcal{A}}

\newcommand{\Dsc}{\mathcal{D}}
\newcommand{\Dscstar}{\mathcal{D}^*}
\newcommand{\btheta}{\theta}
\newcommand{\spaced}[1]{\quad\text{#1}\quad}

% Macros for conditional distributions
\newcommand{\picond}{\pi_{\text{cond}}}
\newcommand{\picondt}{\pi_{\text{cond}, t}}
...
% \titleformat{\part}[display]{\@SPsemibold\scshape\Huge}{\list{}{\rightmargin-0.75in\leftmargin1in}\item[]\centering\thepart\endlist}{1em}{\list{}{\rightmargin-0.75in\leftmargin1in}\item[]\centering#1}[\endlist]
% \titleformat{\chapter}[display]{\@SPsemibold\scshape\Huge}{Chapter \thechapter}{1em}{\raggedright#1}
% \@ifclassloaded{book}{
% \titleformat{\section}{\@SPsemibold\scshape\LARGE}{\thesection.}{1em}{\raggedright#1}
% }{
% \titleformat{\section}{\@SPsemibold\scshape\LARGE}{\thesection}{1em}{\raggedright#1}
% }
...
% \newcommand{\1}[1]{\mathbbold{1}[#1]}
% \newcommand{\Tr}{\mathrm{Tr}}

\newcommand{\unif}[1]{\mathrm{Uniform}(#1)}
...
\newcommand{\DKL}{\mathcal{D}_{\text{KL}}}
...
\newcommand{\normgr}[1]{\left\|#1\right\|}
% \newcommand{\v}[1]{#1}


\DeclareUnicodeCharacter{0301}{GGHHBBGGHH}

\newlength{\myexpandedtextwidth}
\AtBeginDocument{%
  \setlength{\myexpandedtextwidth}{\dimexpr\textwidth+\marginparwidth+\marginparsep\relax}%
}
